...
(function () {
  ...
  var TRANSLATIONS = {
    ru: {
      ...
      cta_note: '3 дня бесплатно · Карта не нужна',
      cta_title: 'Знакомьтесь с теми, кто важен',
      cta_text: 'Пусть MatchAgent берёт на себя отбор. Вы — на связь и встречи.',
      cta_register: 'Попробовать бесплатно',
    ...
    en: {
      ...
      cta_note: '3-day trial · No card required',
      cta_title: 'Start meeting people who matter',
      cta_text: 'Let MatchAgent handle the screening. You focus on the connection.',
      cta_register: 'Start free trial',
