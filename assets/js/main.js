...
(function () {
  ...
  var TRANSLATIONS = {
    ru: {
      ...
      hero_label: 'Футуристичный ИИ-мэтчинг',
      hero_title_1: 'Связь,',
      hero_title_2: 'курируемая ИИ.',
      hero_subtitle: 'Интеллектуальный агент анализирует тысячи сигналов — каждое знакомство осознанное, приватное и достойное вашего времени.',
      story_problem_tag: 'Проблема',
      story_problem_title: 'Бесконечный шум. Ноль намерения.',
      story_problem_text: 'Культура свайпов сжигает внимание. Большинство анкет не соответствуют вашим стандартам — но эмоциональную цену сортировки несёте вы.',
      story_solution_tag: 'Решение',
      story_solution_title: 'ИИ, который знакомится за вас.',
      story_solution_text: 'MatchAgent ведёт параллельные диалоги, проверяет совместимость и формирует шорт-лист — вы подключаетесь, когда это важно.',
      callout_1: 'Критерии',
      callout_2: 'ИИ live',
      callout_3: 'Матчи',
      cta_band_title: 'Готовы к осознанным знакомствам?',
      cta_band_text: 'Начните бесплатный период — агент начнёт отбор сегодня.',
      cta_band_btn: 'Попробовать бесплатно',
    ...
    en: {
      ...
      aria_menu: 'Open menu',
      hero_label: 'Futuristic AI matchmaking',
      hero_title_1: 'Connection,',
      hero_title_2: 'curated by AI.',
      hero_subtitle: 'An intelligent agent screens thousands of signals — so every introduction is intentional, private, and worth your time.',
      story_problem_tag: 'The problem',
      story_problem_title: 'Infinite noise. Zero intention.',
      story_problem_text: 'Swipe culture burns attention. Most profiles never match your standards — yet you still carry the emotional cost of sorting through them.',
      story_solution_tag: 'The solution',
      story_solution_title: 'AI that dates on your behalf.',
      story_solution_text: 'MatchAgent runs parallel dialogues, validates compatibility, and delivers a refined shortlist — you step in only when it matters.',
      callout_1: 'Criteria',
      callout_2: 'Live AI',
      callout_3: 'Matches',
      cta_band_title: 'Ready for intentional dating?',
      cta_band_text: 'Start your free trial — your agent begins screening today.',
      cta_band_btn: 'Start free trial',
